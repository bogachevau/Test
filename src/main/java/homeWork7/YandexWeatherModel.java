...
public class YandexWeatherModel implements WeatherModel {
    ...
    public void getWeather(int period) throws IOException {
        ...
        switch (period) {
            case 1:
                ...
                */
                ...
                System.out.println("Сейчас погода в городе " + cityName + ": " + yesterday + " градусов по цельсию"
                        + "\n" + "Ощущается как: " + feelsLike + " градусов по цельсию");
            ...
            case 5:
                ...
                RequestBody requestBodyFiveDays = RequestBody.create(coordinatesCityAndFiveDays, MediaType.parse("JSON"));
